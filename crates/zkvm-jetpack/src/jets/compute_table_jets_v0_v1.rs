...
pub fn compute_v0_v1_mega_extend_jet(context: &mut Context, subject: Noun) -> Result<Noun, JetErr> {
...
pub fn compute_v0_v1_extend_jet(context: &mut Context, subject: Noun) -> Result<Noun, JetErr> {
    let sam = slot(subject, 6)?;
    let table_mary = slot(sam, 2)?;
