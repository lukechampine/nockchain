...
sam_jet! {
    ...
    bas_mary_jet => bas_mary,
    ext_mary_jet => ext_mary,
    mega_ext_mary_jet => mega_ext_mary,
    make_chals_jet => make_chals,
    make_dyn_list_jet => make_dyn_list_v2 'log,
    weld_exts_jet => weld_exts,
    weld_table_marys_jet => weld_table_marys,
    make_deep_weights_jet => make_deep_weights,
    make_omicrons_jet => make_omicrons,
    get_max_constraint_degree_jet => get_max_constraint_degree,
    make_composition_poly_jet => make_composition_poly,
    make_trace_evals_jet => make_trace_evals,
    build_merk_proof_jet => build_merk_proof,
    add_commitments_jet => add_commitments,
    weld_terminals_jet => weld_terminals,
    make_second_row_trace_polys_jet => make_second_row_trace_polys,
    make_trace_polys_jet => make_trace_polys,
    make_composition_codewords_jet => make_composition_codewords,
    make_deep_challenge_jet => make_deep_challenge,
    make_composition_piece_evals_jet => make_composition_piece_evals,
    make_tworow_trace_polys_eval_jet => make_tworow_trace_polys_eval,
    make_tworow_trace_polys_jet => make_tworow_trace_polys,
    big_chunk_jet => big_chunk,
    augment_challenges_jet => augment_challenges,
    build_mega_extend_jet => build_mega_extend_v2,
    medium_chunk_jet => medium_chunk 'log,
    make_table_exts_jet => make_table_exts_v2 'log,
...
pub const NBX_PROVER_JETS: &[HotEntry] = &[
    ...
    (
        &[
            ...
            jet_str!(b"stark-prover"),
            jet_str!(b"prove-door"),
            jet_str!(b"build-mega-extend"),
        ],
        1,
        build_mega_extend_jet,
    ),
    (
        &[
            K_138,
            ...
            jet_str!(b"stark-prover"),
            jet_str!(b"prove-door"),
            jet_str!(b"weld-table-marys"),
        ],
        1,
        weld_table_marys_jet,
    ),
    (
        &[
            K_138,
    ...
    (
        &[
            ...
            jet_str!(b"stark-prover"),
            jet_str!(b"prove-door"),
            jet_str!(b"make-deep-weights"),
        ],
        1,
        make_deep_weights_jet,
    ),
    (
        &[
            K_138,
    ...
    (
        &[
            ...
            jet_str!(b"pow"),
            jet_str!(b"stark-engine"),
            jet_str!(b"stark-door"),
            jet_str!(b"get-max-constraint-degree"),
        ],
        1,
        get_max_constraint_degree_jet,
    ),
    (
        &[
            K_138,
            ...
            jet_str!(b"stark-prover"),
            jet_str!(b"prove-door"),
            jet_str!(b"make-composition-poly"),
        ],
        1,
        make_composition_poly_jet,
    ),
    (
        &[
            K_138,
            ...
            jet_str!(b"stark-prover"),
            jet_str!(b"prove-door"),
            jet_str!(b"make-trace-evals"),
        ],
        1,
        make_trace_evals_jet,
    ),
    (
        &[
            K_138,
            ...
            jet_str!(b"misc-lib"),
            jet_str!(b"merkle"),
            jet_str!(b"build-merk-proof"),
        ],
        1,
        build_merk_proof_jet,
    ),
    (
        &[
            K_138,
    ...
    (
        &[
            ...
            jet_str!(b"stark-prover"),
            jet_str!(b"prove-door"),
            jet_str!(b"make-second-row-trace-polys"),
        ],
        1,
        make_second_row_trace_polys_jet,
    ),
    (
        &[
            K_138,
            ...
            jet_str!(b"stark-prover"),
            jet_str!(b"prove-door"),
            jet_str!(b"make-trace-polys"),
        ],
        1,
        make_trace_polys_jet,
    ),
    (
        &[
            K_138,
            ...
            jet_str!(b"stark-prover"),
            jet_str!(b"prove-door"),
            jet_str!(b"make-composition-codewords"),
        ],
        1,
        make_composition_codewords_jet,
    ),
    (
        &[
            K_138,
            ...
            jet_str!(b"stark-prover"),
            jet_str!(b"prove-door"),
            jet_str!(b"make-deep-challenge"),
        ],
        1,
        make_deep_challenge_jet,
    ),
    (
        &[
            K_138,
            ...
            jet_str!(b"stark-prover"),
            jet_str!(b"prove-door"),
            jet_str!(b"make-composition-piece-evals"),
        ],
        1,
        make_composition_piece_evals_jet,
    ),
    (
        &[
            K_138,
            ...
            jet_str!(b"stark-prover"),
            jet_str!(b"prove-door"),
            jet_str!(b"make-tworow-trace-polys-eval"),
        ],
        1,
        make_tworow_trace_polys_eval_jet,
    ),
    (
        &[
            K_138,
            ...
            jet_str!(b"stark-prover"),
            jet_str!(b"prove-door"),
            jet_str!(b"make-tworow-trace-polys"),
        ],
        1,
        make_tworow_trace_polys_jet,
    ),
    (
        &[
            K_138,
