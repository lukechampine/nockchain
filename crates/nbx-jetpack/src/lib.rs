...
sam_jet! {
    ...
    make_trace_polys_jet => make_trace_polys 'log,
    make_composition_codewords_jet => make_composition_codewords 'log,
    make_deep_challenge_jet => make_deep_challenge 'log,
    make_composition_piece_evals_jet => make_composition_piece_evals 'log,
}
...
pub const NBX_PROVER_JETS: &[HotEntry] = &[
    ...
    (
        &[
            ...
            jet_str!(b"stark-prover"),
            jet_str!(b"prove-door"),
            Left(b"make-composition-piece-evals"),
        ],
        1,
